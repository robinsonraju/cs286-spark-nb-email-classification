...
/**
 * This class describes a word and the various probabilities associated with that word
 * 
**/
public class WordProbabilityCalculator {
	...
	public WordProbabilityCalculator(String s) {
		word = s;
		countBad = 0;
		countGood = 0;
		rBad = 0.0f;
	...
	// multiply 2 to help fight against false positives (via Graham)
